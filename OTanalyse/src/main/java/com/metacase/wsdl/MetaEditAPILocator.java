...
public class MetaEditAPILocator extends org.apache.axis.client.Service implements com.metacase.wsdl.MetaEditAPI {
    ...
    public com.metacase.wsdl.MetaEditAPIPortType getMetaEditAPIPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacase.wsdl.MetaEditAPIPortType getMetaEditAPIPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacase.wsdl.MetaEditAPISoapBindingStub _stub = new com.metacase.wsdl.MetaEditAPISoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacase.wsdl.MetaEditAPIPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacase.wsdl.MetaEditAPISoapBindingStub _stub = new com.metacase.wsdl.MetaEditAPISoapBindingStub(new java.net.URL(MetaEditAPIPort_address), this);
                _stub.setPortName(getMetaEditAPIPortWSDDServiceName());
                return _stub;
            }
        }
